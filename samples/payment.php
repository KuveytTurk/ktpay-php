...
$cardConfig = \KTPay\Config::getTestCard();
...
$paymentRequest->setSuccessUrl(str_replace('payment.php', 'success.php', \KTPay\Helpers\KTPayHelper::getURL()));
$paymentRequest->setFailUrl(str_replace('payment.php', 'fail.php', \KTPay\Helpers\KTPayHelper::getURL()));
